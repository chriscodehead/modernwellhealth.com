		...
		if ($stmt) {
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				if ($row['blocked_account'] == '0') {
					$blocker = '<a data-toggle="modal" href="#myModalR' . $row['id'] . '"><i class="btn btn-default fa fa-unlock"></i></a><br /> Approved';
				} else {
					$blocker = '<a data-toggle="modal" href="#myModal1' . $row['id'] . '"><i class="btn btn-default fa fa-lock"></i></a><br /> Approve';
				}
		    ...
		    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalR' . $row['id'] . '" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-body">
		                          <p>Are you sure you want to Unapprove this Application</p>
		                      </div>
		                      <div class="modal-footer">
		                          <button data-dismiss="modal" class="btn btn-default" type="button">Cancel</button>
		                          <a href="all-users?block=' . $row['id'] . '">
								  <span class="btn btn-theme">Unapprove</span>
								  </a>
		                      </div>
		                  </div>
		              </div>
		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-footer">
								  ...
								  <span class="btn btn-theme">Approve</span>
								  </a>
		                      </div>
		                  </div>
		              </div>
