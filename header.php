  ...
  <div class="top-bar-left">
   <ul class="top-info">
    <li class="text-2">
     ...
     <div class=" text-3 fw-6">1-555-678-8888</div>
    </li>
    <li class="text-2">
     <div class="title text-2">Support 24/7:</div>
     <div class=" text-3 fw-6"><a href="#">themesflat@gmail.com</a></div>
    </li>
   </ul>
  </div>
  <div class="top-logo">
   <a href="index.html" class="site-logo">
    <img alt="" src="images/logo/logo%402x.png">
   </a>
  </div>
    ...
    <li>
     <div class=" tf-dropdown-sort tf-languages" data-bs-toggle="dropdown">
      <div class="btn-select">
       <span class="text-sort-value">EN</span><i class="icon-CaretDown"></i>
      </div>
      <div class="dropdown-menu">
       ...
       <div class="select-item">
        <span class="text-value-item">VIE</span>
       </div>
      </div>
     </div>
    </li>
    <li>
     <ul class="tf-social style-1">
      <li><a href="#">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
         ...
         <g clip-path="url(#clip0_11072_5627)">
          <path d="M6.25 11.25L8.75 8.75L11.25 11.25L13.75 8.75" stroke="#3C210E"
      ...
      <li><a href="#">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
         xmlns="http://www.w3.org/2000/svg">
         <g clip-path="url(#clip0_11072_5644)">
          <path
      ...
      <li><a href="#">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
         xmlns="http://www.w3.org/2000/svg">
         <g clip-path="url(#clip0_11072_5649)">
          <path
           ...
           stroke="#3C210E" stroke-width="1.5" stroke-linecap="round"
           stroke-linejoin="round" />
          <path d="M6.25 10.5375L17.4539 2.50781" stroke="#3C210E"
           stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path
             ...
             <div class="wrap-list">
              <div class="box-listings">
               <div class="image-wrap">
                <img src="images/blog/blog-details-list-1.jpg"
                 alt="">
               </div>
               <div class="content">
                <ul class="meta">
              ...
              <div class="box-listings">
               <div class="image-wrap">
                <img src="images/blog/blog-details-list-2.jpg"
                 alt="">
               </div>
               <div class="content">
                <ul class="meta">
                ...
                <div class="title text-1 fw-5 ">
                 <a class="line-clamp-2"
                  href="blog-details.html">Effective
                  Strategies
                  for
                  Managing Anxiety</a>
                </div>
              ...
              <div class="box-listings">
               <div class="image-wrap">
                <img src="images/blog/blog-details-list-4.jpg"
                 alt="">
               </div>
               <div class="content">
                <ul class="meta">
        ...
        <g clip-path="url(#clip0_10985_955)">
         <g clip-path="url(#clip1_10985_955)">
          <path
           ...
           stroke="#3C210E" stroke-width="1.5" stroke-linecap="round"
           stroke-linejoin="round" />
          <path d="M2.80469 7.13965H20.8047" stroke="#3C210E" stroke-width="1.5"
