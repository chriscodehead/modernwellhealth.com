...
(function (e) {
    ...
    e.fn.fitVids = function (t) {
        ...
        r.innerHTML =
            "Ă‚Â­<style>               .fluid-width-video-wrapper {                 width: 100%;                              position: relative;                       padding: 0;                            }                                                                                   .fluid-width-video-wrapper iframe,        .fluid-width-video-wrapper object,        .fluid-width-video-wrapper embed {           position: absolute;                       top: 0;                                   left: 0;                                  width: 100%;                              height: 100%;                          }                                       </style>";
            ...
            (((t = function (t, e) {
                ...
                (a.$elm = i(t)),
                    a.$elm.is("svg") &&
                        ...
                        (a.totalDuration =
                            o.duration + o.stagger * a.$paths.length),
                    ...
                    function t(e, n) {
                        !(function (t, e) {
                            ...
                            e &&
                                ...
                                this.settings.customContainer &&
                                    (console.log(
                                        o(this.settings.customContainer)[0]
                                    ),
    ...
    function m(n, t) {
        return n && 0 != n.length
            ? n.nodeName
                ? [n]
                : [].slice.call(
                      n[0].nodeName ? n : (t || u).querySelectorAll(n)
                  )
            : [];
    }
    function o(n) {
            ...
            m(n.childNodes).some(function (n) {
                if (!n.tagName || n.hasChildNodes()) {
                    if (n.childNodes && n.childNodes.length)
                        return (
                            s.push(n), void c.push.apply(c, v(n, r, i, u, o))
                        );
                    var t = n.wholeText || "",
                        e = t.trim();
                    e.length &&
        ...
        o(this).on("click", function (e) {
            ...
            o("body").append(
                ...
                o(".YouTubePopUp-Wrap").hasClass("YouTubePopUp-animation") &&
                    setTimeout(function () {
                        o(".YouTubePopUp-Wrap").removeClass(
